/**
 * Example: Using Pattern Integration with V3 Neural Module
 *
 * Demonstrates:
 * - Creating a Pattern learning engine
 * - Learning from trajectories
 * - Adapting behavior based on context
 * - Performance monitoring (sub-ms learning target)
 */
...
import { getModeConfig } from '../src/pattern-manager.js';
...
async function basicLearningExample() {
  ...
  // Create Pattern engine with balanced mode
  const modeConfig = getModeConfig('balanced');
  const sona = createPatternLearningEngine('balanced', modeConfig);

  console.log(`Created Pattern engine (balanced mode)`);
...
async function adaptationExample() {
  ...
  // Create Pattern engine with real-time mode (fastest)
  const modeConfig = getModeConfig('real-time');
  const sona = createPatternLearningEngine('real-time', modeConfig);

  console.log(`Created Pattern engine (real-time mode)`);
...
async function patternDiscoveryExample() {
  ...
  const sona = createPatternLearningEngine('research', modeConfig);

  console.log(`Created Pattern engine (research mode)`);
...
async function performanceMonitoringExample() {
  ...
  for (const mode of modes) {
    ...
    const sona = createPatternLearningEngine(mode, modeConfig);
...
async function main() {
  console.log('\n╔═══════════════════════════════════════════════════════════╗');
  console.log('║   Pattern Integration Examples - V3 Neural Module           ║');
