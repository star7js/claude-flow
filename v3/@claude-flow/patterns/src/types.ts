 ...
 * Core type definitions for Pattern learning modes and ReasoningBank integration
 *
 * Performance Targets:
 * - pattern adaptation: sub-ms
...
/**
 * Available Pattern learning modes with their characteristics
 */
export type PatternMode = 'real-time' | 'balanced' | 'research' | 'edge' | 'batch';

/**
 * Configuration for each Pattern mode
 */
...
export type PatternEvent =
  ...
  | { type: 'mode_changed'; fromMode: PatternMode; toMode: PatternMode }
  | { type: 'memory_consolidated'; memoriesCount: number };

/**
 * Event listener type
 */
export type PatternEventListener = (event: PatternEvent) => void | Promise<void>;
...
export type {
  PatternMode as LearningMode,
  PatternModeConfig as ModeConfig,
