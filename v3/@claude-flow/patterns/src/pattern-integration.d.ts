...
import type { Trajectory, PatternMode, PatternModeConfig } from './types.js';
/**
 ...
 */
export declare function createPatternLearningEngine(mode: PatternMode, modeConfig: PatternModeConfig): PatternLearningEngine;
