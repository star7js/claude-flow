...
import { createPatternManager, PatternManager } from './pattern-manager.js';
...
export class ReasoningBankAdapter {
  ...
  private readonly sonaManager: PatternManager;
  ...
  constructor(config?: ReasoningBankConfig) {
    ...
    this.sonaManager = createPatternManager(this.config.sonaMode);
