/**
 * V3 Byzantine Fault Tolerant Voting
 * PBFT-style voting for handling disagreeing agents in-process
 */
...
export interface ByzantineConfig extends Partial<VotingConfig> {
  maxFaultyNodes?: number;
  viewChangeTimeoutMs?: number;
}

export class ByzantineVoting extends EventEmitter {
...
export function createByzantineVoting(
  nodeId: string,
  config?: ByzantineConfig
): ByzantineVoting {
  return new ByzantineVoting(nodeId, config);
}
