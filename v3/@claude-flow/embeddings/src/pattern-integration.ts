...
export class PatternEmbeddingService {
  ...
  /**
   * Process input through full pattern substrate
   */
 ...
 */
export function createNeuralService(config: NeuralSubstrateConfig = {}): PatternEmbeddingService {
  return new PatternEmbeddingService(config);
}
